...
- Kiristyshaittaohjelmilla käytiin yli miljardin edestä bisnestä
...
Kuten kuvassa näkyy molemmat tavat toimivat. Kunhan vain muistaa aina testata ettei nettiä ole ennen nmap komentoja :)
LISÄÄ KUVA, ETSI GALLERIASTA SS
### Porttiskannaus
c)
...
d)
Seuraavaksi laitoin päälle kaksi daemonia jotta pystymme tutkimaan mitä komento tulostaa kun muutama portti on auki. :smiling_imp: 
  - SSH :smiling_imp:
  - apache2 :smiling_imp:
...
e) Asensin Metasploitable 2 zip tiedoston [täältä](https://sourceforge.net/projects/metasploitable/). Sen jälkeen purin tiedoston. Tämän jälkeen loin normaalistin uuden virtuaalikoneen VMBoxissa. Pidin oletusasetukset, paitsi muutin  Hard Disk asetuksen. Tästä laitoin asetuksen "Use existing Virtual Hard Disk file jonka jälkeen laitoin puretun metasploitable.vmdk kyseiseksi tiedostoksi.
...
## Kaksi mielenkiintoisinta aukinaista porttia Metasploit VM:ssa
