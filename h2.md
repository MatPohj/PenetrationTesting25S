...
Seuraavaksi tallennetaan sama skannaus tiedostoon
...
- -a, pystyy filtteröimään että tietty ip osoite näkyy.
- -o, Käyttöjärjestelmän avulla (Mikäli se on havaittu)
- -C pystyy lisäämään kommentin
