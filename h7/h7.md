...
Katsoin tarkemmin task9, että mikä oli adminin salasana, jos se olisi väärin. Tajusin samalla, että käyttäjänimi ei ole "Admin" vaan "administraton". Testasin uudestaan oikealla käyttäjänimellä ja pääsin koneseen sisään
...
Tässä ehkä fiksumpi tapa olisi ollut etsiä tiedostoa flag.txt, eikä manuaalisesti etsiä tiedostoa.
